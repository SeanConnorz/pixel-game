...
export default function About() {
  return (
    <section className="flex flex-col items-center my-[30rem] w-full md:w-[50%] text-center">
      <h1 className="mb-[2rem]">What is Pixel World?</h1>
      <p className="about-info w-[80%] md:w-[50%] md:text-[0.8rem]">
